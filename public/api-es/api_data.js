define({ "api": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "/sinonim/samsung?sort={\"ctgr_bstng\":{\"order\":\"desc\"},\"pop_score\":{\"order\":\"desc\"},\"sel_prc\":{\"order\":\"asc\"}}&&match={\"prd_nm\":\"s8%20plus\"}&&page=0&&limit=10"
      }
    ],
    "filename": "routes/web.php",
    "groupTitle": "Search_Get",
    "name": "GetSinonimKeywords"
  }
] });
